...
export declare type ResolveState<State extends IState | null | undefined> = State extends undefined ? State : {
    [P in keyof State]: State[P] extends (parent: ResolveState<IState>, root: any) => any ? State[P] extends () => any ? State[P] : ReturnType<State[P]> : State[P] extends Array<any> ? State[P] : State[P] extends IState | null ? ResolveState<State[P]> : State[P];
};
