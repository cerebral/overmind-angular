...
export declare type IState = {
    [key: string]: IState | string | IDerive<any, any, any> | number | boolean | object | null | undefined;
};
...
export interface IReaction<ThisConfig extends IConfiguration> {
    <O>(stateCallback: (state: ResolveState<ThisConfig['state']>) => O, updateCallback: (value: O) => void, options?: {
        nested?: boolean;
        immediate?: boolean;
    }): () => void;
}
...
export declare type IDerive<ThisConfig extends IConfiguration, Parent extends IState, Value> = (parent: ResolveState<Parent>, state: ResolveState<ThisConfig['state']>) => Value;
