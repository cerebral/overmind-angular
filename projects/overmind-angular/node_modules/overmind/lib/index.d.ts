...
import { DefaultMode, Events, NestedPartial, Options, ResolveActions, ResolveState, SSRMode, TestMode } from './internalTypes';
import { createMutationOperator, createOperator } from './operator';
import { IAction, IConfiguration, IContext, IDerive, IOnInitialize, IOperator, IReaction, IState } from './types';
export * from './types';
...
export declare const derived: <S extends IState, V, C = Config>(cb: IDerive<C, S, V>) => V;
...
export interface Derive<Parent extends IState, Value> extends IDerive<Config, Parent, Value> {
}
