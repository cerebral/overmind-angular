...
exports.SERIALIZE = rehydrate_1.SERIALIZE;
exports.rehydrate = rehydrate_1.rehydrate;
var statemachine_1 = require("./statemachine");
exports.statemachine = statemachine_1.statemachine;
exports.derived = (cb) => cb;
...
class Overmind {
    ...
    reconfigure(configuration) {
        const mergedConfiguration = Object.assign(Object.assign({}, configuration), { state: utils_1.mergeState(this.originalConfiguration.state, this.state, configuration.state) });
